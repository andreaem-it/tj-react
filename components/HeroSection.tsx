  ...
  return (
    <section className="w-full mb-6 md:mb-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 lg:grid-rows-2 gap-2 md:gap-3">
        ...
        <div className="relative lg:col-start-1 lg:col-span-6 lg:row-span-2 min-h-[220px] sm:min-h-[280px] lg:min-h-[320px]">
          <ArticleCard post={first} variant="hero" size="large" priority />
        </div>
        {/* Colonna 2 (3/12): elemento medio */}
        <div className="relative lg:col-start-7 lg:col-span-3 lg:row-span-2 min-h-[200px] sm:min-h-[240px] lg:min-h-[320px]">
        ...
        <div
          className={
            hasFourth
              ? "relative lg:col-start-10 lg:col-span-3 lg:row-start-1 min-h-[150px] sm:min-h-[155px] lg:min-h-[158px]"
              : "relative lg:col-start-10 lg:col-span-3 lg:row-span-2 min-h-[200px] sm:min-h-[240px] lg:min-h-[320px]"
          }
        >
          {third && <ArticleCard post={third} variant="hero" size="small" />}
        </div>
        {hasFourth && (
          <div className="relative lg:col-start-10 lg:col-span-3 lg:row-start-2 min-h-[150px] sm:min-h-[155px] lg:min-h-[158px]">
