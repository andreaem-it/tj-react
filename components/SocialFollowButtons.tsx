  ...
  return (
    <div className="flex gap-4 items-start">
      <a
        ...
        className="flex min-h-11 flex-1 items-center justify-center gap-2 rounded bg-[#3b5998] py-2.5 text-sm font-medium text-white hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      >
      ...
      <a
        ...
        className="flex min-h-11 flex-1 items-center justify-center gap-2 rounded bg-[#c13584] py-2.5 text-sm font-medium text-white hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      >
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
