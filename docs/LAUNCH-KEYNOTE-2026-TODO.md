...
- [x] Aggiungere nella dashboard e nell’editor articoli lo stato audio sempre visibile, progress bar indeterminata e azione di rigenerazione per i job falliti.
